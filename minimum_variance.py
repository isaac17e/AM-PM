...
ax.set_title("Frontera Eficiente - Minimo Riesgo de Cola (BKM)", fontweight="bold", fontsize=15)
...
for (idx, row), color in zip(df_weights.iterrows(), colors):
    ...
    bottom += row["Weight"]
ax.set_title("Asignacion Optima de Activos - Minimo Riesgo de Cola", fontweight="bold", fontsize=13)
